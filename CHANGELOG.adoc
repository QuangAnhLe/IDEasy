...
* https://github.com/devonfw/IDEasy/issues/2419[#2419]: Add an experimental Docker Sandbox to run AI coding agents in an isolated container with a provisioned IDEasy workspace
